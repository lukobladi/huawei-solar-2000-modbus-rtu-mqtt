...
#mqtt_host = os.getenv('MQTT_HOST', '46.183.118.192')
mqtt_host = os.getenv('MQTT_HOST', 'esparzasolar.duckdns.org')
...
clientMQTT.username_pw_set(username="eneko",password="3n3sh.eo")
